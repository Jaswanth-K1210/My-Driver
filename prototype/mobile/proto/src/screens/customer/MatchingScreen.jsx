...
const CHECKS = ['Police background check', 'Face-match handshake armed', 'VisionCam standby']

export default function MatchingScreen({ onMatched }) {
  ...
  useEffect(() => {
    const t = setTimeout(onMatched, 1800)
  ...
  return (
    ...
    >
      ...
      <View style={{ alignItems: 'center', gap: space.xs }}>
        <Text style={{ ...type.title, color: colors.text }}>Matching a certified driver…</Text>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6 }}>
          <Clock size={13} color={colors.textMuted} />
          <Text style={{ ...type.tiny, color: colors.textMuted }}>Usually under 20 seconds</Text>
        </View>
      </View>
